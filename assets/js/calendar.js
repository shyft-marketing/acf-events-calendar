    ...
    function showEventModal(event) {
        ...
        if (props.event_address) {
            ...
            if (typeof props.event_address === 'object') {
                ...
                // If we have lat/lng, create a Google Maps link
                if (props.event_address.lat && props.event_address.lng) {
                    ...
                    html += '<span class="event-value">';
                    html += '<a href="' + mapsUrl + '" target="_blank" rel="noopener">' + 
                           escapeHtml(address) + '</a>';
                    html += '</span>';
                } else {
                    html += '<span class="event-value">' + escapeHtml(address) + '</span>';
                }
            } else {
                html += '<span class="event-value">' + escapeHtml(props.event_address) + '</span>';
            }
            html += '</div>';
        }
